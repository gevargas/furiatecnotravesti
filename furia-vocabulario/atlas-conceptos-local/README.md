...
La aplicación utiliza los CSV de nodos y aristas producidos por el notebook del proyecto. Todo el procesamiento ocurre en el navegador: los archivos no se cargan en un servidor ni se transmiten a servicios externos.
...
Selecciona simultáneamente los siguientes archivos:
