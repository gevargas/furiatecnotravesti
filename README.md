...
* conversational tools based on large language models, with an emphasis on models that can be executed locally;

* privacy-preserving and resource-efficient technical architectures;

* interfaces for navigating and understanding an ontology of public terms curated by Fundación Furia Trans;

* methods for evaluating the usefulness, limitations and risks of these technologies.
